...
参考ページはこちら [Firebase Pages](https://firebase.google.com/docs/auth/ios/password-auth?authuser=0)

## Installation
今回はCocoaPodsとSwiftPackageManagerを併用します。
...
参考ページはこちら [Firebaseの設定](https://firebase.google.com/docs/auth/ios/google-signin?authuser=0#2_implement_google_sign-in)
